...
If you want, I can also tailor the README to your exact **seeded demo accounts** (admin/author/reader usernames + passwords) if you paste what your `DbSeeder` creates, so testers can log in instantly without guessing.
